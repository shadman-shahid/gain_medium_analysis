...
*/
#ifndef _SATURABLE_ABSORBER_H
#define _SATURABLE_ABSORBER_H

#include "imaterialplugin.h"
#include <vector>

class SaturableAbsorberPlugin : public IMaterialPlugin
{
public:
    SaturableAbsorberPlugin(){};
    virtual ~SaturableAbsorberPlugin(){};

    const char* name() const {return "Saturable Absorber";};
